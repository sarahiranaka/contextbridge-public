...
- **Evaluation records.** [`evals/`](evals/) holds the three runs above, with exact prompts, verbatim model outputs, reviewer annotations, and post hoc notes.
